...
function create() {
    var Identificacion = document.getElementById("IdentificacionMedico").value.trim();
    var Password = document.getElementById("PasswordMedico").value.trim();
    var Nombre = document.getElementById("NombreMedico").value.trim();
    var Apellido = document.getElementById("ApellidoMedico").value.trim();
    var Telefono = document.getElementById("TelefonoMedico").value.trim();
    var Genero = document.getElementById("GeneroMedico").value.trim();
    var Email = document.getElementById("EmailMedico").value.trim();
